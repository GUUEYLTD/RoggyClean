...
function wp_elementy_vc_after() {
    ...
    /* Add new VC Param Type */
	vc_add_shortcode_param( 'cms_time', 'wp_elementy_time_settings_field', get_template_directory_uri() . '/assets/js/jquery.datetimepicker.js' );
...
function wp_elementy_time_settings_field($settings, $value) {
...
function wp_elementy_front_end_scripts() {
	...
	wp_enqueue_script('bootstrap-affix', get_template_directory_uri() . '/assets/js/bootstrap.affix.js', array(), '3.3.2');

	/* Add 3rd plugins */
	wp_enqueue_script('imagesloaded', get_template_directory_uri() . '/assets/js/jquery.imagesloaded.js', array( 'jquery' ), '3.1.8', true);
    ...
    wp_enqueue_script('text-rotator', get_template_directory_uri() . '/assets/js/text-rotator.js', array( 'jquery' ), '1.0.0', true);
    ...
    wp_enqueue_script('backgroundvideo', get_template_directory_uri() . '/assets/js/jquery.backgroundvideo.min.js', array( 'jquery' ), '1.0.0', true);
...
function wp_elementy_widgets_init() {
	...
	register_sidebar( array(
		...
		'description' => esc_html__( '', 'wp-elementy' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
		'before_title' => '<h3 class="wg-title">',
		'after_title' => '</h3>',
