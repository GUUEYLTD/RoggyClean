...
<div class="elementy-table-resp">
	<div class="table-responsive">
		<form action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post" class="mw-100-767">
		<div class="mb-60">
					...
					foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
						...
						if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
							...
							<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
								...
								<td class="product-name" data-title="<?php esc_html_e( 'Product', 'wp-elementy' ); ?>">
									<?php
										if ( ! $_product->is_visible() ) {
								...
								<td class="product-price" data-title="<?php esc_html_e( 'Price', 'wp-elementy' ); ?>">
									<?php
										echo apply_filters( 'woocommerce_cart_item_price', WC()->cart->get_product_price( $_product ), $cart_item, $cart_item_key );
									?>
								</td>

								<td class="product-quantity" data-title="<?php esc_html_e( 'Quantity', 'wp-elementy' ); ?>">
									<?php
								...
								<td class="product-subtotal" data-title="<?php esc_html_e( 'Total', 'wp-elementy' ); ?>">
									<?php
								...
								<td class="product-remove">
									<?php
										echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf(
											'<a href="%s" class="remove icon-close" title="%s" data-product_id="%s" data-product_sku="%s">&times;</a>',
		...
		<div class="cms-coupon-wrap row">
				...
				<?php if ( WC()->cart->coupons_enabled() ) { ?>
					<div class="coupon row">
						...
						<div class="col-sm-6 mb-30">
							<input type="submit" class="cms-button cms-gray md cms-shape-round w-100-767" name="apply_coupon" value="<?php esc_html_e( 'Apply code', 'wp-elementy' ); ?>" />	
						</div>
			...
			<div class="col-sm-4 text-right text-center-767 mb-30">
				<input type="submit" class="cms-button md cms-shape-round cms-gray w-100-767" name="update_cart" value="<?php esc_html_e( 'Update cart', 'wp-elementy' ); ?>" />
