...
<?php if ( ! WC()->cart->is_empty() ) : ?>
	...
	<p class="buttons">
		<a href="<?php echo esc_url( wc_get_cart_url() ); ?>" class="cms-button sm wc-forward"><?php esc_html_e( 'View Cart', 'wp-elementy' ); ?></a>
		<a href="<?php echo esc_url( wc_get_checkout_url() ); ?>" class="cms-button sm checkout wc-forward"><?php esc_html_e( 'Checkout', 'wp-elementy' ); ?></a>
	</p>
