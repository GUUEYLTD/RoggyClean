...
vc_map(array(
    ...
    "params" => array(
        ...
        array(
            "type" => "textfield",
            "heading" => esc_html__("Extra Class",'wp-hosthubs'),
            "param_name" => "el_class",
            "value" => "",
            "description" =>"",
            'group' => 'Custom'
        ...
        array(
            "type" => "dropdown",
            "heading" => esc_html__("Font family",'wp-hosthubs'),
        ...
        array(
            'type' => 'css_editor',
            'heading' => esc_html__( 'CSS box', 'wp-hosthubs' ),
            'param_name' => 'css',
            'group' => esc_html__( 'Design Options', 'wp-hosthubs' ),
        ),
    )
));
